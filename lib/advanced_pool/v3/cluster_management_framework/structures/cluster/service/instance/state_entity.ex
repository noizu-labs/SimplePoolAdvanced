...
defmodule  Noizu.AdvancedPool.V3.ClusterManagement.Cluster.Service.Instance.State do
  use Noizu.DomainObject
  @vsn 1.0
  @sref "service-instance-state"
  @persistence_layer {Noizu.AdvancedPool.V3.Database, cascade_block?: true, table: Noizu.AdvancedPool.V3.Database.Cluster.Service.Instance.State.Table}
  defmodule Entity do
