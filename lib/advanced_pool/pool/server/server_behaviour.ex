...
defmodule Noizu.AdvancedPool.V3.ServerBehaviour do
  @moduledoc """
  ...
  defmodule Default do
    ...
    defp meta_init_default_definition(module, options) do
      a_s = Application.get_env(:noizu_advanced_pool, :definitions, %{})
      template = %Noizu.AdvancedPool.MonitoringFramework.Service.Definition{
  ...
  defmacro __using__(options) do
    ...
    quote do
      ...
      @behaviour Noizu.AdvancedPool.V3.ServerBehaviour
      ...
      def initial_state(definition, context) do
        ...
        #effective = %Noizu.AdvancedPool.MonitoringFramework.Service.HealthCheck{
      ...
      def handle_health_check!(state, _args, _from, _context, _options \\ nil) do
        dummy_response = %Noizu.AdvancedPool.MonitoringFramework.Service.HealthCheck{
          identifier: {node(), pool()},
          process: self(),
          time_stamp: DateTime.utc_now(),
          status: :online,
      ...
      def enable_server!(elixir_node \\ nil) do
        Noizu.AdvancedPool.V3.ServerBehaviour.Default.enable_server!(__MODULE__, @active_key, elixir_node)
      end

      def server_online?(elixir_node \\ nil) do
        Noizu.AdvancedPool.V3.ServerBehaviour.Default.server_online?(__MODULE__, @active_key, elixir_node)
      end

      def disable_server!(elixir_node \\ nil) do
        Noizu.AdvancedPool.V3.ServerBehaviour.Default.disable_server!(__MODULE__, @active_key, elixir_node)
      end
