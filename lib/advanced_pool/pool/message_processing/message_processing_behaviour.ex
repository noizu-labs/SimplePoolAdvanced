...
defmodule Noizu.AdvancedPool.V3.MessageProcessingBehaviour do
  require Logger
  ...
  defmodule DefaultProvider do
    defmacro __using__(_options) do
      quote do
        require Logger
        @module __MODULE__
        @behaviour Noizu.AdvancedPool.V3.MessageProcessingBehaviour
        alias Noizu.AdvancedPool.V3.MessageProcessingBehaviour.Default
        #===============================================================================================================
        # Call routing
        #===============================================================================================================
