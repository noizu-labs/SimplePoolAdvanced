...
defmodule  Noizu.AdvancedPool.MonitoringFramework.Server.HealthCheck do
  ...
  @type t :: %__MODULE__{
               ...
               services: %{module => Noizu.AdvancedPool.MonitoringFramework.Services.HealthCheck.t},
  ...
  defimpl Inspect, for: Noizu.AdvancedPool.MonitoringFramework.Server.HealthCheck do
