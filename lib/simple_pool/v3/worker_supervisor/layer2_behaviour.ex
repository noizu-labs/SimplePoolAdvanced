...
defmodule Noizu.SimplePool.V3.WorkerSupervisor.Layer2Behaviour do
  @moduledoc """
  ...
  defmacro __using__(options) do
    implementation = Keyword.get(options || [], :implementation, Noizu.SimplePool.V3.WorkerSupervisor.Layer2Behaviour.Default)
