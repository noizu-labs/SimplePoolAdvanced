...
defmodule Noizu.SimplePool.V3.ServerBehaviour do
  ...
  defmacro __using__(options) do
    implementation = Keyword.get(options || [], :implementation, Noizu.SimplePool.V3.ServerBehaviour.Default)
    option_settings = implementation.prepare_options(options)

    # Temporary Hardcoding
    router_provider = Noizu.SimplePool.V3.RouterBehaviour.DefaultProvider
    worker_management_provider = Noizu.SimplePool.V3.WorkerManagementBehaviour.DefaultProvider
    service_management_provider = Noizu.SimplePool.V3.ServiceManagementBehaviour.DefaultProvider
    ...
    quote do
      ...
      @behaviour Noizu.SimplePool.V3.ServerBehaviour
      ...
      def enable_server!(elixir_node \\ nil) do
        Noizu.SimplePool.V3.ServerBehaviour.Default.enable_server!(__MODULE__, @active_key, elixir_node)
      end

      def server_online?(elixir_node \\ nil) do
        Noizu.SimplePool.V3.ServerBehaviour.Default.server_online?(__MODULE__, @active_key, elixir_node)
      end

      def disable_server!(elixir_node \\ nil) do
        Noizu.SimplePool.V3.ServerBehaviour.Default.disable_server!(__MODULE__, @active_key, elixir_node)
      end
