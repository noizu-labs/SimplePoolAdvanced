...
#-------------------------------------------------------------------------------
defmodule Noizu.SimplePool.V3.ClusterManagementFramework.Cluster.ServiceManager do
  @moduledoc """
  ...
  use Noizu.SimplePool.V3.PoolBehaviour,
      ...
      worker_state_entity: Noizu.SimplePool.V3.ClusterManagementFramework.Cluster.ServiceManager.WorkerEntity,
      verbose: false
  ...
  def service_health_report(service, context, _options \\ %{}) do
    c = Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.StateRepo.get!(service, context) # c = Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.StateRepo.cached(service, context)
    c && c.health_report
  end
  ...
  def service_instance_definition(service, instance, context, options \\ %{}) do
    c = cond do
      options[:cache] == false -> Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.StateRepo.get!(service, context, options)
      true -> Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.StateRepo.get!(service, context) # c = Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.StateRepo.cached(service, context)
    end
  ...
  defmodule Server do
    ...
    def initial_state([service, configuration], context) do
      ...
      service_state = case Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.StateEntity.entity!(service) do
        v =  %Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.StateEntity{} ->
          v
          |> Noizu.SimplePool.V3.ClusterManagement.Cluster.StateEntity.reset(context, configuration)
          |> Noizu.SimplePool.V3.ClusterManagement.Cluster.StateRepo.update!(context)
        _ -> Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.StateEntity.ref(service)
      end
