...
#-------------------------------------------------------------------------------
defmodule Noizu.SimplePool.V3.ClusterManagementFramework.ClusterManager do
  @moduledoc """
  ...
  def health_report(context) do
    c = Noizu.SimplePool.V3.ClusterManagement.Cluster.StateRepo.get!(@cluster, context) # c = Noizu.SimplePool.V3.ClusterManagement.Cluster.StateRepo.cached(@cluster, context)
    c && c.health_report
  end
  ...
  def cluster_manager_tenancy() do
    c = Noizu.SimplePool.V3.ClusterManagement.Cluster.StateEntity.entity!(@cluster) # c = Noizu.SimplePool.V3.ClusterManagement.Cluster.StateRepo.cached(@cluster, context)
    c && c.node
  end
  ...
  def log_event(level, event, detail, context) do
    c = Noizu.SimplePool.V3.ClusterManagement.Cluster.StateRepo.get!(@cluster, context) # c = Noizu.SimplePool.V3.ClusterManagement.Cluster.StateRepo.cached(@cluster, context)
    subject = Noizu.SimplePool.V3.ClusterManagement.Cluster.StateEntity.ref(@cluster)
  ...
  def service_definitions(context, options \\ %{}) do
    c = cond do
      options[:cache] == false -> Noizu.SimplePool.V3.ClusterManagement.Cluster.StateRepo.get!(@cluster, context)
      true -> Noizu.SimplePool.V3.ClusterManagement.Cluster.StateRepo.get!(@cluster, context) # c = Noizu.SimplePool.V3.ClusterManagement.Cluster.StateRepo.cached(@cluster, context, options)
    end
  ...
  defmodule Server do
    ...
    def initial_state(_configuration, context) do
      cluster_state = case  Noizu.SimplePool.V3.ClusterManagement.Cluster.StateEntity.entity!(@cluster) do
        v =  %Noizu.SimplePool.V3.ClusterManagement.Cluster.StateEntity{} ->
          v
          |> Noizu.SimplePool.V3.ClusterManagement.Cluster.StateEntity.reset(context)
    ...
    def call__bring_service_online(state,  _service, _instructions, context) do
      ...
      Noizu.SimplePool.V3.ClusterManagement.Cluster.StateRepo.update!(state.entity, Noizu.ElixirCore.CallingContext.system(context))
