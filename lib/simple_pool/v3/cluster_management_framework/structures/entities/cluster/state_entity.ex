...
defmodule  Noizu.SimplePool.V3.ClusterManagement.Cluster.StateEntity do
  @vsn 1.0
  @type t :: %__MODULE__{
               identifier: atom,
               node: atom,
               ...
               state: atom,
               pending_state: atom,
               cluster_definition: Noizu.SimplePool.V3.ClusterManagement.Cluster.Definition.t,
  ...
  use Noizu.Scaffolding.V2.EntityBehaviour,
      ...
      entity_table:  Noizu.SimplePool.V3.Database.Cluster.StateTable

  defimpl Noizu.ERP, for: Noizu.SimplePool.V3.ClusterManagement.Cluster.StateEntity do
