...
defmodule  Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.StateEntity do
  @vsn 1.0
  @type t :: %__MODULE__{
               identifier: atom,
               status: atom,
               state: atom,
               pending_state: atom,
               service_definition: Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.Definition.t,
               status_details: Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.Status.t,
  ...
  use Noizu.Scaffolding.V2.EntityBehaviour,
      ...
      entity_table:  Noizu.SimplePool.V3.Database.Cluster.Service.StateTable

  defimpl Noizu.ERP, for: Noizu.SimplePool.V3.ClusterManagement.Cluster.Service.StateEntity do
