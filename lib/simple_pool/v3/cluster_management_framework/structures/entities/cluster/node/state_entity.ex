...
defmodule  Noizu.SimplePool.V3.ClusterManagement.Cluster.Node.StateEntity do
  @vsn 1.0
  @type t :: %__MODULE__{
               identifier: atom,
               status: atom,
               state: atom,
               pending_state: atom,
               node_definition: Noizu.SimplePool.V3.ClusterManagement.Cluster.Node.Definition.t,
               status_details: Noizu.SimplePool.V3.ClusterManagement.Cluster.Node.Status.t,
  ...
  use Noizu.Scaffolding.V2.EntityBehaviour,
      ...
      entity_table:  Noizu.SimplePool.V3.Database.Cluster.Node.StateTable

  defimpl Noizu.ERP, for: Noizu.SimplePool.V3.ClusterManagement.Cluster.Node.StateEntity do
