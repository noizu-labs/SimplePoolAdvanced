...
defmodule Noizu.SimplePool.V3.StandAloneServiceBehaviour do
  ...
  defmacro __using__(options) do
    implementation = Keyword.get(options || [], :implementation, Noizu.SimplePool.V3.PoolBehaviour.Default)
    ...
    quote do
      require Logger
      @behaviour Noizu.SimplePool.V3.PoolBehaviour
      @implementation unquote(implementation)
      @module __MODULE__

      use Noizu.SimplePool.V3.SettingsBehaviour.Base, unquote([option_settings: option_settings, stand_alone: true])
      ...
      if (unquote(default_modules.pool_supervisor)) do
        defmodule PoolSupervisor do
          use Noizu.SimplePool.V3.PoolSupervisorBehaviour, unquote(options.pool_supervisor_options)
        end
      end
