...
defmodule Noizu.SimplePool.V3.ServiceManagementBehaviour do
  require Logger
  ...
  defmodule DefaultProvider do
    defmacro __using__(_options) do
      quote do
        require Logger
        @behaviour Noizu.SimplePool.V3.ServiceManagementBehaviour
        @pool_server Module.split(__MODULE__) |> Enum.slice(0..-2) |> Module.concat()
        alias Noizu.SimplePool.V3.Server.State, as: ServerState
        alias Noizu.SimplePool.Server.EnvironmentDetails
        alias Noizu.SimplePool.V3.ServiceManagement.ServiceManagementProvider, as: Provider
