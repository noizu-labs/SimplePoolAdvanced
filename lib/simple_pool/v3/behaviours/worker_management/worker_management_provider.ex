...
defmodule Noizu.SimplePool.V3.WorkerManagement.WorkerManagementProvider do
  require Logger
  ...
  def dispatch_new(ref, pool_server, _context, options) do
    ...
    %Noizu.SimplePool.V3.DispatchEntity{identifier: ref, server: server, state: state, lock: lock}
  end
