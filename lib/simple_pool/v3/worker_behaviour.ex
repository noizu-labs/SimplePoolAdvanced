...
defmodule Noizu.SimplePool.V3.WorkerBehaviour do
  ...
  defmacro __using__(options) do
    implementation = Keyword.get(options || [], :implementation, Noizu.SimplePool.V3.WorkerBehaviour.Default)
    ...
    quote do
      ...
      def cast_router_catchall(envelope, state) do
        Noizu.SimplePool.V3.MessageProcessingBehaviour.Default.__delegate_cast_handler(__MODULE__, envelope, state)
      end
      def info_router_catchall(envelope, state) do
        Noizu.SimplePool.V3.MessageProcessingBehaviour.Default.__delegate_info_handler(__MODULE__, envelope, state)
      end
