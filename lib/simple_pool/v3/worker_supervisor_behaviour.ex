...
defmodule Noizu.SimplePool.V3.WorkerSupervisorBehaviour do
  ...
  defmodule Default do
    ...
    def prepare_options(options) do
      ...
      default_layer2_provider = Noizu.SimplePool.V3.WorkerSupervisor.Layer2Behaviour
  ...
  defmacro __using__(options) do
    implementation = Keyword.get(options || [], :implementation, Noizu.SimplePool.V3.WorkerSupervisorBehaviour.Default)
    ...
    quote do
      ...
      def worker_start(ref, context), do: Noizu.SimplePool.V3.WorkerSupervisorBehaviour.Default.worker_start(__MODULE__, ref, context)
      ...
      """
      def meta_init(), do: Noizu.SimplePool.V3.WorkerSupervisorBehaviour.Default.meta_init(__MODULE__)
      ...
      def group_children(group_fn), do: Noizu.SimplePool.V3.WorkerSupervisorBehaviour.Default.group_children(__MODULE__, group_fn)
      def count_children(), do: Noizu.SimplePool.V3.WorkerSupervisorBehaviour.Default.count_children(__MODULE__)
      def current_supervisor(ref), do: Noizu.SimplePool.V3.WorkerSupervisorBehaviour.Default.current_supervisor(__MODULE__, ref)
