...
defmodule Noizu.SimplePoolAdvanced.V3.StandAloneServiceBehaviour do
  @moduledoc """
  ...
  defmacro __using__(options) do
    ...
    quote do
      ...
      use Noizu.SimplePoolAdvanced.V3.SettingsBehaviour.Base, unquote([option_settings: option_settings, stand_alone: true])
