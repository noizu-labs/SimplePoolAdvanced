...
defmodule Noizu.SimplePoolAdvanced.V3.MonitorBehaviour do
  ...
  defmacro __using__(options) do
    ...
    quote do
      ...
      def record_service_event!(event, details, context, opts \\ %{}) do
        Noizu.SimplePoolAdvanced.V3.MonitorBehaviour.Default.record_service_event!(@pool, event, details, context, opts)
      end
