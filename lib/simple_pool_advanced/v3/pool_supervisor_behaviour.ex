...
defmodule Noizu.SimplePoolAdvanced.V3.PoolSupervisorBehaviour do
  ...
  defmacro __using__(options) do
    implementation = Keyword.get(options || [], :implementation, Noizu.SimplePoolAdvanced.V3.PoolSupervisorBehaviour.Default)
    ...
    quote do
      @behaviour Noizu.SimplePoolAdvanced.V3.PoolSupervisorBehaviour
      use Supervisor
      require Logger
