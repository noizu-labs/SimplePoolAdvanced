...
defmodule Noizu.SimplePoolAdvanced.V3.ServerBehaviour do
  @moduledoc """
  ...
  defmodule Default do
    ...
    defp meta_init_default_definition(module, options) do
      a_s = Application.get_env(:noizu_simple_pool_advanced, :definitions, %{})
      template = %Noizu.SimplePoolAdvanced.MonitoringFramework.Service.Definition{
      ...
      _default_definition = case options.default_definition do
                              :auto ->
                                case a_s[module.pool()] || a_s[:default] do
                                  d = %Noizu.SimplePoolAdvanced.MonitoringFramework.Service.Definition{} ->
                                    %{d|
  ...
  defmacro __using__(options) do
    implementation = Keyword.get(options || [], :implementation, Noizu.SimplePoolAdvanced.V3.ServerBehaviour.Default)
    option_settings = implementation.prepare_options(options)

    # Temporary Hardcoding
    router_provider = Noizu.SimplePoolAdvanced.V3.RouterBehaviour.DefaultProvider
    worker_management_provider = Noizu.SimplePoolAdvanced.V3.WorkerManagementBehaviour.DefaultProvider
    service_management_provider = Noizu.SimplePoolAdvanced.V3.ServiceManagementBehaviour.DefaultProvider
    ...
    quote do
      ...
      @behaviour Noizu.SimplePoolAdvanced.V3.ServerBehaviour
      ...
      def initial_state(definition, context) do
        ...
        #effective = %Noizu.SimplePoolAdvanced.MonitoringFramework.Service.HealthCheck{
      ...
      def worker_sup_start(ref, context) do
        Logger.warn("[V2] Server.worker_sup_start is deprecated | #{inspect ref}: #{unquote(__ENV__.file)}:#{unquote(__ENV__.line)}", Noizu.ElixirCore.CallingContext.metadata(context))
      ...
      def handle_health_check!(state, _args, _from, _context, _options \\ nil) do
        dummy_response = %Noizu.SimplePoolAdvanced.MonitoringFramework.Service.HealthCheck{
          identifier: {node(), pool()},
          process: self(),
          time_stamp: DateTime.utc_now(),
          status: :online,
          directive: :free,
          definition: %Noizu.SimplePoolAdvanced.MonitoringFramework.Service.Definition{
      ...
      def enable_server!(elixir_node \\ nil) do
        Noizu.SimplePoolAdvanced.V3.ServerBehaviour.Default.enable_server!(__MODULE__, @active_key, elixir_node)
      end

      def server_online?(elixir_node \\ nil) do
        Noizu.SimplePoolAdvanced.V3.ServerBehaviour.Default.server_online?(__MODULE__, @active_key, elixir_node)
      end

      def disable_server!(elixir_node \\ nil) do
        Noizu.SimplePoolAdvanced.V3.ServerBehaviour.Default.disable_server!(__MODULE__, @active_key, elixir_node)
      end
