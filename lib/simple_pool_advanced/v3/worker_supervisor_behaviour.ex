...
defmodule Noizu.SimplePoolAdvanced.V3.WorkerSupervisorBehaviour do
  @moduledoc """
  ...
  defmodule Default do
    ...
    def meta_init(module) do
      ...
      parent_settings = Noizu.SimplePoolAdvanced.V3.SettingsBehaviour.Default.meta_init(module, %{})
  ...
  defmacro __using__(options) do
    implementation = Keyword.get(options || [], :implementation, Noizu.SimplePoolAdvanced.V3.WorkerSupervisorBehaviour.Default)
    ...
    quote do
      @behaviour Noizu.SimplePoolAdvanced.V3.WorkerSupervisorBehaviour
      use Supervisor
      require Logger
      ...
      def worker_start(ref, transfer_state, context), do: Noizu.SimplePoolAdvanced.V3.WorkerSupervisorBehaviour.Default.worker_start(__MODULE__, ref, transfer_state, context)
      def worker_start(ref, context), do: Noizu.SimplePoolAdvanced.V3.WorkerSupervisorBehaviour.Default.worker_start(__MODULE__, ref, context)
      ...
      """
      def meta_init(), do: Noizu.SimplePoolAdvanced.V3.WorkerSupervisorBehaviour.Default.meta_init(__MODULE__)
      ...
      def group_children(group_fn), do: Noizu.SimplePoolAdvanced.V3.WorkerSupervisorBehaviour.Default.group_children(__MODULE__, group_fn)
      def count_children(), do: Noizu.SimplePoolAdvanced.V3.WorkerSupervisorBehaviour.Default.count_children(__MODULE__)
      def current_supervisor(ref), do: Noizu.SimplePoolAdvanced.V3.WorkerSupervisorBehaviour.Default.current_supervisor(__MODULE__, ref)
