...
defmodule  Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State do
  use Noizu.DomainObject
  @vsn 1.0
  @sref "cluster-state"
  @persistence_layer {Noizu.SimplePoolAdvanced.V3.Database, cascade_block?: true, table: Noizu.SimplePoolAdvanced.V3.Database.Cluster.State.Table}
  defmodule Entity do
