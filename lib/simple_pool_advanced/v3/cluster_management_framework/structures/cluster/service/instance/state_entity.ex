...
defmodule  Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.Service.Instance.State do
  use Noizu.DomainObject
  @vsn 1.0
  @sref "service-instance-state"
  @persistence_layer {Noizu.SimplePoolAdvanced.V3.Database, cascade_block?: true, table: Noizu.SimplePoolAdvanced.V3.Database.Cluster.Service.Instance.State.Table}
  defmodule Entity do
    Noizu.DomainObject.noizu_entity() do
      identifier :atom
      public_field :status, :unkmown
      public_field :state, :offline
      public_field :pending_state, :offline
      public_field :service_instance_definition
