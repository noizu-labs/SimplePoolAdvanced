...
defmodule  Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.Service.Instance.Status do
  @vsn 1.0
  @type t :: %__MODULE__{
               service: any,
               node: any,
               ...
               state: atom,
               pending_state: atom,
               health_report: Noizu.SimplePoolAdvanced.V3.ClusterManagement.HealthReport.t,
