...
#-------------------------------------------------------------------------------
defmodule Noizu.SimplePoolAdvanced.V3.ClusterManagementFramework.ClusterManager do
  @moduledoc """
  ...
  def health_report(context) do
    c = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Repo.get!(@cluster, context) # c = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Repo.cached(@cluster, context)
    c && c.health_report
  end
  ...
  def cluster_manager_tenancy() do
    c = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Entity.entity!(@cluster) # c = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Repo.cached(@cluster, context)
    c && c.node
  end
  ...
  def log_event(level, event, detail, context) do
    c = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Repo.get!(@cluster, context) # c = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Repo.cached(@cluster, context)
    subject = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Entity.ref(@cluster)
  ...
  def service_definitions(context, options \\ %{}) do
    c = cond do
      options[:cache] == false -> Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Repo.get!(@cluster, context)
      true -> Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Repo.get!(@cluster, context) # c = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Repo.cached(@cluster, context, options)
    end
  ...
  defmodule Server do
    ...
    def initial_state(_configuration, context) do
      cluster_state = case  Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Entity.entity!(@cluster) do
        v =  %Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Entity{} ->
          v
          |> Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Entity.reset(context)
    ...
    def call__bring_service_online(state,  _service, _instructions, context) do
      ...
      Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Repo.update!(state.entity, Noizu.ElixirCore.CallingContext.system(context))
