...
#-------------------------------------------------------------------------------
defmodule Noizu.SimplePoolAdvanced.V3.ClusterManagementFramework.Cluster.ServiceManager do
  @moduledoc """
  ...
  use Noizu.SimplePoolAdvanced.V3.PoolBehaviour,
      ...
      worker_state_entity: Noizu.SimplePoolAdvanced.V3.ClusterManagementFramework.Cluster.ServiceManager.WorkerEntity,
      verbose: false
  ...
  def service_health_report(service, context, _options \\ %{}) do
    c = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.Service.State.Repo.get!(service, context) # c = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.Service.State.Repo.cached(service, context)
    c && c.health_report
  end
  ...
  def service_instance_definition(service, instance, context, options \\ %{}) do
    c = cond do
      options[:cache] == false -> Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.Service.State.Repo.get!(service, context, options)
      true -> Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.Service.State.Repo.get!(service, context) # c = Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.Service.State.Repo.cached(service, context)
    end
  ...
  defmodule Server do
    ...
    def initial_state([service, configuration], context) do
      ...
      service_state = case Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.Service.State.Entity.entity!(service) do
        v =  %Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.Service.State.Entity{} ->
          v
          |> Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Entity.reset(context, configuration)
          |> Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.State.Repo.update!(context)
        _ -> Noizu.SimplePoolAdvanced.V3.ClusterManagement.Cluster.Service.State.Entity.ref(service)
      end
