...
defmodule  Noizu.SimplePoolAdvanced.MonitoringFramework.Server.HealthCheck do
  alias Noizu.SimplePoolAdvanced.MonitoringFramework.Server.Resources
  alias Noizu.SimplePoolAdvanced.MonitoringFramework.LifeCycleEvent
  ...
  @type t :: %__MODULE__{
               ...
               services: %{module => Noizu.SimplePoolAdvanced.MonitoringFramework.Services.HealthCheck.t},
  ...
  defimpl Inspect, for: Noizu.SimplePoolAdvanced.MonitoringFramework.Server.HealthCheck do
