...
defmodule  Noizu.SimplePoolAdvanced.MonitoringFramework.Service.HealthCheck do
  alias Noizu.SimplePoolAdvanced.MonitoringFramework.Service.Definition
  ...
  def template(pool, options \\ %{}) do
    ...
    %Noizu.SimplePoolAdvanced.MonitoringFramework.Service.HealthCheck{
  ...
  defimpl Inspect, for: Noizu.SimplePoolAdvanced.MonitoringFramework.Service.HealthCheck do
