...
defmodule Noizu.AdvancedPool.Support.TestPool2 do
  use Noizu.AdvancedPool
  Noizu.AdvancedPool.Server.default()
  
  def __worker__(), do: Noizu.AdvancedPool.Support.TestPool2.Worker
...
defmodule Noizu.AdvancedPool.Support.TestPool2.Worker do
