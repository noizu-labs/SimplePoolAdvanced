defmodule Noizu.AdvancedPool.Support.NodeManager.ConfigurationProvider do
  ...
  alias Noizu.AdvancedPool.Support.{TestPool, TestPool2, TestPool3, TestPool4}

  def configuration(node) do
    case node do
      :nap_test_runner@localhost -> [TestPool, TestPool2, TestPool4]
      _ -> [TestPool2, TestPool3, TestPool4]
    end
    |> Enum.map(fn(service) ->
  ...
  def configuration() do
    ...
    [TestPool, TestPool2, TestPool3, TestPool4]
    |> Enum.into(%{},
         fn(service) ->
