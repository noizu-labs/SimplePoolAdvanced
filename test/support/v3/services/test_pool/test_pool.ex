...
defmodule Noizu.SimplePool.Support.TestV3Pool do
  ...
  use Noizu.SimplePool.V3.PoolBehaviour,
      ...
      worker_state_entity: Noizu.SimplePool.Support.TestV3WorkerEntity,
      dispatch_table: Noizu.SimplePool.TestDatabase.TestV3Pool.DispatchTable,
      verbose: false
